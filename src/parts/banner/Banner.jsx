...
function Banner() {
  return (
    <div className="relative flex flex-col gap-6 px-4 py-6 overflow-hidden text-white md:px-8 grow md:py-14 rounded-xl bg-gradient-to-r from-purple-banner-1 to-purple-banner-2 max-h-80">
